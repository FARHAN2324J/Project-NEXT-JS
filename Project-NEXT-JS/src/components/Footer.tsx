    ...
    <div className="bg-[#161617cc] gap-10 py-10 grid grid-cols-1 text-[#fffc] sm:grid-cols-2">
      <div className="flex flex-col gap-6 px-10">
        ...
        <div className="flex items-center gap-3">
          <Image src="/images/mobile_16076069.png" className="w-[7%] sm:w-[8%] md:w-[8%] lg:w-[5%] xl:w-[4%]" width={100} height={100} alt="" /><span>+1254298</span>
        </div>
        <div className="flex items-center gap-3">
          <Image src="/images/telegram_2111646.png" className="w-[7%] sm:w-[8%] md:w-[8%] lg:w-[5%] xl:w-[4%]" width={100} height={100} alt="" /><span>@confused4298</span>
        </div>
        <div className="flex items-center gap-3">
          <Image src="/images/instagram_2111463.png" className="w-[7%] sm:w-[8%] md:w-[8%] lg:w-[5%] xl:w-[4%]" width={100} height={100} alt="" /><span>@confused4298</span>
        </div>
      </div>
