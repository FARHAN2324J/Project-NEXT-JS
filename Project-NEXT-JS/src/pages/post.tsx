...
const Post = () => {
  ...
  const handleSubmit = () => {
    ...
    router.push('/posts'); // هدایت به صفحه‌ی AllPosts
    router.push('/')
  };
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center Div-Post-create">
        {step === 1 && (
          <div className="w-[100%]">
            <div className="bg-[#161617cc] w-[90%] sm:w-[40%] lg:w-[50%] xl:w-[40%] md:w-[60%] m-auto rounded-2xl">
              ...
              <div className="flex flex-col text-center">
                <Image className="w-[10%] m-auto py-5" width={100} height={100} src="/icon/image-svgrepo-com (1).svg" alt="" />
              ...
              {image && (
                <div className="w-full img-create">
                  <Image src={image} width={100} height={100} className="w-[80%] py-5 m-auto rounded-md" alt="Uploaded" />
                </div>
              )}
          ...
          <div className="w-[100%]">
            <div className="bg-[#161617cc] w-[90%] sm:w-[40%] lg:w-[50%] xl:w-[40%] md:w-[60%] m-auto flex-col md:flex-row flex gap-5 items-center justify-between px-5 py-2 rounded-tl-2xl rounded-tr-2xl container-content">
              <div className="flex gap-2 items-center w-[100%]">
                <input
                  className="sm:text-md text-sm my-2 text-[#9ca3af] bg-transparent"
                  type="text"
              ...
              <div className="w-[100%]">
                <textarea
                  className="text-[#9ca3af] sm:text-md text-sm my-2 bg-transparent"
            ...
            {image && (
              <div className="bg-[#161617cc] w-[90%] sm:w-[40%] lg:w-[50%] xl:w-[40%] md:w-[60%] m-auto rounded-bl-2xl rounded-br-2xl p-5">
                <Image className="md:w-[60%] w-[100%] m-auto" width={100} height={100} src={image} alt="Uploaded" />
              </div>
            )}
